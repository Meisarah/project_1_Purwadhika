      ...
      <div className="container">
        <div className="row np">
            <div className="col-sm-6">
                    <img src={gamis1} alt="Gamis"/>
            </div>
            <div className="col-sm-6">
            
                <p><strong>{gamis.name}</strong></p>
                    <p>Black Gamis</p> 
                    <p>{gamis.harga}</p>
                    <h4>Description</h4>
                    <p>{gamis.deskripsi}</p>
                    <ul id="harga">
                        ...
                        <li>Motif : Lengan bermotif </li>
                        <li>Style : {gamis.style} </li>
                    </ul>
